...
module Prawnder
  module TemplateHandlers
    class Renderer
      ...
      PRAWNS = %w(bounds bounding_box draw_text fill_circle fill_color fill_rectangle find_font float font font_size font_registry font_families go_to_page draw_textzontal_line horizontal_rule line_width margin_box margins move_down move_up pad pad_top pad_bottom page_number page_count reference_bounds repeat rotate set_font save_font start_new_page scale stroke_color stroke_gradient stroke_horizontal_rule stroke_rectangle text text_box transformation_matrix translate transparent width_of)
